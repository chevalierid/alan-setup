...
//16312381/877297/2.50/2/3/Resistor
...
(library Library_1
	...
	(symbolDef "RC0603FR-0730KL" (originalName "RC0603FR-0730KL")
	...
	(compDef "RC0603FR-0730KL" (originalName "RC0603FR-0730KL") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RC0603FR-0730KL"))
		...
		(attr "Manufacturer_Part_Number" "RC0603FR-0730KL")
		(attr "Mouser Part Number" "603-RC0603FR-0730KL")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/YAGEO/RC0603FR-0730KL?qs=diQw95jMAeNFr44yr782FQ%3D%3D")
		(attr "Arrow Part Number" "RC0603FR-0730KL")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/rc0603fr-0730kl/yageo?region=nac")
		(attr "Description" "Yageo 30k, 0603 (1608M) Thick Film SMD Resistor +/-1% 0.1W - RC0603FR-0730KL")
		(attr "<Hyperlink>" "https://www.yageo.com/upload/media/product/app/datasheet/rchip/pyu-rc_group_51_rohs_l.pdf")
		(attr "<Component Height>" "0.55")
		(attr "<STEP Filename>" "RC0603FR-0730KL.stp")
