...
File root;
RTC_DS3231 rtc;
uint32_t delta_ts[] = {2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2};
...
void loop() {
  ...
  if (getCurrentTime() >= last_write_time + delta_ts[day_index]) {
    

   if (day_index % 2 == 0 & day_index > 0) {
      ...
      switch (day_index) {
        case 1:
          ...
          break;
        case 3:
          Serial.println("white should be off");
          arr_on = 0;
          break;
        case 5:
          Serial.println("press override button now. white should be on");
          break;
        case 7:
          Serial.println("release override and turn dial to off. everything should be off");
          arr_on = 1;
          break;
        case 9:
          ...
          break;
        case 11:
          Serial.println("press override button now. everything should still be off");
          break;
        case 13:
          Serial.println("turn dial to amber. amber should be on");
          arr_on = 1;
          break;
        case 15:
          Serial.println("amber should be off");
          arr_on = 0;
          break;
        case 17:
          Serial.println("press override button now. amber should be on");
          break;
    }
    day_index++;
    last_write_time = getCurrentTime();
